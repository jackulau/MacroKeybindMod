...
This file records attribution and licensing for MacroKeybindMod and the third-party
material in this repository.

## MacroKeybindMod's own code — MIT, clean-room

The MacroKeybindMod source under `engine/`, `fabric/`, and `docs/` is an original,
...
MacroKeybindMod is a revival of **The Macro / Keybind Mod** by **Mumfrey**
...
is **"All Rights Reserved."** MacroKeybindMod is an independent project and is **not**
...
- **NOT** part of the shipped mod (the `dist/` jars contain only MacroKeybindMod + the bundled engine),
- **NOT** to be redistributed or pushed to any public remote,
- **NOT** to be copied verbatim into MacroKeybindMod's source.
